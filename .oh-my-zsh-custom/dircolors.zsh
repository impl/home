...
# This file is constructed from the following information
DIR_COLORS_RC=<<'EOF'
...
# Linux (GNU coreutils) "standard" LS_COLORS
...
# *BSD supports a primitive version of LS_COLORS
LSCOLORS='ExGxFxDaCxDaDaHBaDHeac';
export LSCOLORS
